    ...
    <div class="video-main">
      <div class="video-space"></div>
        <div class="video-title">
          <h1>The Framers' Method 2/9: Origin Story: A Battle of Ideas</h1>
        </div>
        <div class="video-date">
          <p>06 Nov 2023</p>
        </div>
        <div class="video-iframe-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/6qxy36qwHE4?si=bJpijl29LDAbUQKb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
